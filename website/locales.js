...
const zhCN = Object.freeze({
  ...
  'meta.ogDescription': '来做俯卧撑吧！AI识别计数,放心，Just do it!',
  'meta.ogLocale': 'zh_CN',
  'skip.main': '跳到主要内容',
...
const ko = Object.freeze({
  ...
  'steps.trainBody':
    '머리, 어깨, 몸통을 화면 안에 유지하세요. 준비가 되면 시작하고, 카운트와 중국어 음성 안내는 자동으로 진행됩니다.',
  'steps.scope':
