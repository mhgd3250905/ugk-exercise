...
const zhCN = Object.freeze({
  ...
  'apk.title': '直接下载',
  'apk.body': '开放后，用 Android 手机扫码就能安装。',
  'apk.status': '即将开放',
  'apk.placeholder': '下载码准备中',
  'apk.action': '点击下载安装包',
  'apk.qrLabel': '手机扫码下载',
...
const en = Object.freeze({
  ...
  'apk.body': 'Once available, scan with your Android phone to install.',
  'apk.status': 'Coming soon',
  'apk.placeholder': 'Download code in progress',
...
const es = Object.freeze({
  ...
  'apk.body': 'Cuando esté disponible, escanea con tu Android para instalarlo.',
  'apk.status': 'Muy pronto',
  'apk.placeholder': 'Código de descarga en preparación',
...
const fr = Object.freeze({
  ...
  'apk.body': 'Dès que ce sera prêt, scannez avec votre téléphone Android pour l’installer.',
  'apk.status': 'Bientôt disponible',
  'apk.placeholder': 'Code de téléchargement en préparation',
...
const de = Object.freeze({
  ...
  'apk.body': 'Sobald verfügbar, scannst du den Code mit deinem Android-Smartphone und installierst die App.',
  'apk.status': 'Demnächst verfügbar',
  'apk.placeholder': 'Download-Code wird vorbereitet',
...
const ptBR = Object.freeze({
  ...
  'apk.body': 'Quando estiver disponível, escaneie com seu Android para instalar.',
  'apk.status': 'Em breve',
  'apk.placeholder': 'Código de download em preparação',
...
const ja = Object.freeze({
  ...
  'apk.title': '直接ダウンロード',
  'apk.body': '公開後は、Androidスマートフォンでコードを読み取るだけでインストールできます。',
  'apk.status': '近日公開',
  'apk.placeholder': 'ダウンロードコードを準備中',
...
const ko = Object.freeze({
  ...
  'apk.title': '바로 다운로드',
  'apk.body': '공개되면 Android 휴대폰으로 코드를 스캔해 바로 설치할 수 있어요.',
  'apk.status': '곧 공개',
  'apk.placeholder': '다운로드 코드 준비 중',
