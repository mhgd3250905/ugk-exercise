...
| 内部测试新版本 | `0.3.6 (7)` USER REPORTED PUBLISHED | 用户报告 `0.3.6-internal-1` 已于 2026-07-15 09:14（北京时间）面向内部测试人员发布；包含 1 个版本代码，尚待从 Play 独立安装验收 |
| 内部测试 | PASS | `0.3.5 (6)` 已从 Google Play 的 Internal Early Access 商店页安装并启动；安装器为 `com.android.vending`，包不可调试 |
| 封闭测试 | PASS | 用户报告 `0.3.4-closed-1` 已于 2026-07-14 10:42 在 Google Play 面向 Alpha 测试人员全面发布 |
| Play 安装 | `0.3.5 (6)` PASS | 内部测试安装版已确认版本、Google 登录、会员恢复及重启后会员保持 |
...
2026-07-15 `0.3.6 (7)` 内部测试产物（用户报告已发布，待 Play 安装验收）：
...
- 状态：用户报告发布名称 `0.3.6-internal-1` 已于 2026-07-15 09:14（北京时间）面向内部测试人员发布，包含 1 个版本代码；本轮尚未从 Play 独立安装验收。Google Play 的 UGC、Data safety 和内容分级声明尚未记录为完成，因此不得推进 Alpha 或 Production。
