...
| Google Play 测试轨道（最后核对 2026-07-20） | Internal `0.3.14 (17)` 与 Alpha `0.3.11 (14)` 均已全面发布 | Play Console 独立核对：`0.3.14-internal-1` 于 2026-07-20 11:42 面向内部测试人员发布；`0.3.11-closed-1` 于 2026-07-19 11:50 面向 Alpha 测试人员发布 |
...
| 当前 App 主线 | `main@6774dc8` | 已包含月卡 3 天与年卡 7 天试用购买卡片、精确 Offering 条款识别、无资格安全回退和 Google Play 订阅管理入口；本地与远端 main 已核对一致 |
| 当前 Internal 发布 | `0.3.14 (17)` 已全面发布 | AAB 源提交 `7f84e58`；发布名称 `0.3.14-internal-1`；Play 安装与双试用运行验收尚未执行 |
...
| Play 安装验收 | `0.3.13 (16)` MONTHLY TRIAL CORE PASS / `0.3.14 (17)` PENDING | `0.3.13` 已验证月卡试用核心链路；`0.3.14` 刚发布到 Internal，尚未从 Play 安装并验证双试用卡片。取消、到期、历史账号无资格与年卡运行链路仍待独立场景 |
...
- 本会话于 2026-07-20 独立核对并发布：当前 Internal 为 `0.3.14-internal-1`，`versionCode=17`，已于 11:42（北京时间）面向内部测试人员全面发布。
...
- `0.3.14 (17)` 基于已同步的 `main@6774dc8`，候选分支为 `codex/play-0.3.14-candidate`，AAB 源提交为 `7f84e58ef3515b67254dbb19088084b5219e4220`。版本包含月卡 3 天与年卡 7 天试用卡片、精确 Offering 条款识别、无资格安全回退和 Google Play 订阅管理入口；不包含 Worker、D1 或 API 合同变更。
...
- 2026-07-20 经用户明确授权，将上述同一核验 AAB 上传并发布为 Internal `0.3.14-internal-1`。Play Console 预览确认 `17 (0.3.14)`、中英文版本说明及各设备类型不再支持数均为 0；11:42（北京时间）显示“已面向内部测试人员发布”。未推进 Alpha、开放测试或 Production；尚未从 Play 安装本版本，不能把发布成功扩写为双试用运行链路通过。
