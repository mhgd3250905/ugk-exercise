...
| Google Play 测试轨道（最后核对 2026-07-21） | Internal `0.3.16 (19)` 与 Alpha `0.3.14 (17)` 已全面发布 | Play Console 独立核对：`0.3.16-internal-1` 于 2026-07-21 03:22 面向内部测试人员发布；`0.3.14-closed-1` 于 2026-07-20 14:28 面向 Alpha 测试人员发布 |
| 已发布 Internal 源码 | `codex/play-0.3.16-candidate@1e47a08`；`0.3.16 (19)` | 训练历史本地缓存、过期会员保留已下载记录、训练状态提示条优化和会员到期续订核验修复；核验 AAB 已发布到 Internal |
| 当前 App 主线 | `main@c79b14e` | 会员到期续订核验修复已合入；本地与远端 main 已核对一致 |
| 当前 Internal 发布 | `0.3.16 (19)` 已全面发布 | AAB 源提交 `1e47a08`；发布名称 `0.3.16-internal-1`；Play 已确认 `versionCode=19` 面向内部测试人员发布，Play 安装/覆盖更新验收待执行 |
| 当前 Alpha 发布 | `0.3.14 (17)` 已全面发布 | `0.3.14-closed-1` 于 2026-07-20 14:28 面向 Alpha 测试人员发布；本轮不推进或修改 Alpha |
| 最新 Internal 功能版 | `0.3.16 (19)` 已全面发布 | `codex/play-0.3.16-candidate@1e47a08`；AAB `187207830` 字节，SHA-256 `4C2E23654BB558BF94A920C2B6DD9CB98D1E935967B1B2D6C971C9AD3F25F614` |
