...
| 当前 Internal 源码 | `codex/play-0.3.9-candidate@3bb285b`；`0.3.9 (12)` | 已包含启动/榜单视觉、会员刷新进度、记录日期水印卡、版本号与 Play 更新入口；同一核验 AAB 已发布到 Internal |
...
| P1 | 验证 App 内更新提示 | `0.3.9 (12)` 已发布到 Internal；尚未记录旧 Play 安装版获得更新后的实际表现 | 从 Play 安装的 `0.3.8 (11)` 验证标签出现、商品页正确、覆盖更新成功且数据保留 |
