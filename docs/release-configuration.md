...
| Google Play 测试轨道（最后核对 2026-07-21） | Internal `0.3.15 (18)` 与 Alpha `0.3.14 (17)` 已全面发布 | Play Console 独立核对：`0.3.15-internal-1` 于 2026-07-20 18:15 面向内部测试人员发布；`0.3.14-closed-1` 于 14:28 面向 Alpha 测试人员发布 |
| 已发布 Internal 源码 | `codex/play-0.3.15-candidate@36a987e`；`0.3.15 (18)` | 冷启动后台检查、主题化非强制更新弹窗、双语更新列表和 Google Play 跳转；核验 AAB 已发布到 Internal |
| 当前 App 主线 | `main@c79b14e` | 会员到期续订核验修复已合入；本地与远端 main 已核对一致 |
| 当前 Internal 发布 | `0.3.15 (18)` 已全面发布 | AAB 源提交 `36a987e`；发布名称 `0.3.15-internal-1`；Play 已确认 bundle 有效且面向内部测试人员全面发布 |
| 当前 Alpha 发布 | `0.3.14 (17)` 已全面发布 | `0.3.14-closed-1` 于 2026-07-20 14:28 面向 Alpha 测试人员发布；本轮不推进或修改 Alpha |
| 下一 Internal 候选 | `0.3.16 (19)` 已构建核验，尚未上传 | `codex/play-0.3.16-candidate@1e47a08`；训练历史本地缓存与过期会员保留已下载记录、训练状态提示条优化、会员到期续订核验修复；AAB `187207830` 字节，SHA-256 `4C2E23654BB558BF94A920C2B6DD9CB98D1E935967B1B2D6C971C9AD3F25F614` |
...
- 本会话于 2026-07-21 独立核对：当前 Internal 为 `0.3.15-internal-1`，`versionCode=18`，已于 2026-07-20 18:15（北京时间）面向内部测试人员全面发布。
