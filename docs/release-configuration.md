...
| 当前 Internal 发布 | `0.3.13 (16)` 已全面发布 | `feat/new-feature`；AAB 源提交 `6374a3c`；发布名称 `0.3.13-internal-1`；Play 安装版功能验收待记录 |
...
| Play 安装验收 | `0.3.11 (14)` USER REPORTED PASS / `0.3.12 (15)` PENDING / `0.3.13 (16)` PENDING | 用户报告旧 Internal 测试通过但未提供逐项清单；`0.3.13` 已发布，仍需从 Play 安装后验收 3 天试用购买链路 |
