...
| 封闭测试 | 审核中 | 用户报告 `0.3.4-closed-1` 已开始全面发布，当前显示“正在快速检查常见问题”和“正在审核中的更改”，尚未向测试人员发布 |
...
2026-07-14 Alpha 候选产物（内部测试验收通过，Alpha 快速检查/审核中）：
...
- 用户报告同一 `5 (0.3.4)` App Bundle 已用于 `0.3.4-closed-1` 并开始 Alpha 全面发布；Console 当前显示“正在快速检查常见问题”和“正在审核中的更改”，尚不能记为已向测试人员发布。
