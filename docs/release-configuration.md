...
| 窄距与积分榜上线门槛 | WORKER DEPLOYED / APP NOT RELEASED | 2026-07-18 已先部署兼容 Worker，并完成积分指标、旧次数查询和训练同步的未登录 `401` 探针；未执行 D1 migration，未改变量、Secret 或 binding。新 App 仍须在有效会话下验收 `pushup_points_v1` 后再发布 |
